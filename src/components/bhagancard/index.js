...
export default function BhajanCard({ videoId , thumbnail, title , description }) {
  ...
  return (
    <div onClick={() => router.push(`/bhajan/${videoId}`)} className="col-span-3 flex flex-col justify-center items-center bg-orange-600 text-white p-4 rounded-lg cursor-pointer">
